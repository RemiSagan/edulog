 ...
 */
final class Version20200225114845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE specialty DROP FOREIGN KEY FK_E066A6ECA76ED395');
        $this->addSql('DROP INDEX IDX_E066A6ECA76ED395 ON specialty');
        $this->addSql('ALTER TABLE specialty DROP user_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE specialty ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE specialty ADD CONSTRAINT FK_E066A6ECA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_E066A6ECA76ED395 ON specialty (user_id)');
    }
}
